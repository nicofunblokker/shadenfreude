...
addStyle(wb, sheet = sheetname, style = createStyle(fgFill = 'grey95', halign = "left", valign = "center", wrapText = TRUE, border = "BottomTopRightLeft", borderColour = c("white", "white","black","black" )), rows = 3:6, cols = 2:6, gridExpand = TRUE)
addStyle(wb, sheet = sheetname, style = createStyle(fgFill = 'grey95', halign = "left", valign = "center", wrapText = TRUE, border = "LeftBottomRight", borderColour = "black"), rows = 7, cols = 2:6, gridExpand = TRUE)
...
addStyle(wb, sheet = sheetname, style = createStyle(fgFill = 'grey95', halign = "center", valign = "center", wrapText = TRUE, border = "BottomTopRightLeft", borderColour = "black"), rows = 10:11, cols = 2:6, gridExpand = TRUE)
